package com.s406.livon.domain.auth.service;


import com.s406.livon.domain.user.repository.UserRepository;
import com.s406.livon.global.error.handler.MailHandler;
    ...
    public void joinEmail(String email,String text) {
        ...
        String content =
                "<!DOCTYPE html>" +
                        ...
                        "<div style='font-size:20px;font-weight:700;letter-spacing:.3px'>LivOn 방문을 환영합니다 ✨</div>"+
                        ...
                        "© "+ java.time.LocalDate.now() +" LivOn · 본 메일은 발신전용입니다"+
                        "</td></tr>"+
                        "</table>"+
                        "</td></tr>"+
                        "</table>"+
