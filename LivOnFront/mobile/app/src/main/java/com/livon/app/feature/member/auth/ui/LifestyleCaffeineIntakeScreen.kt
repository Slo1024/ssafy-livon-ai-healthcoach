...
fun LifestyleCaffeinIntakeScreen() {
    ...
    val options = listOf("거의 안 마심", "하루 1잔 정도", "하루 2~3잔", "하루 4잔 이상")
...
//        Spacer(Modifier.height(15.dp))
        ...
        Column(
            ...
            RequirementText("평소 카페인 섭취는 얼마나 하시나요?")
            Spacer(Modifier.height(3.dp))
            CaptionText("커피, 에너지 음료 등을 포함합니다.")
...
@Composable
private fun PreviewLifestyleCaffeinIntakeScreen() = PreviewSurface { LifestyleCaffeinIntakeScreen() }
