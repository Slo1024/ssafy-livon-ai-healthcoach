...
import CoachOnlyPage from "../pages/common/CoachOnlyPage";
    ...
    <Router>
      <Layout>
        <Routes>
          ...
          {/* 코치 전용 안내 페이지 */}
          <Route path={ROUTES.COACH_ONLY} element={<CoachOnlyPage />} />
          ...
          <Route
            ...
            element={<div>이메일 인증 페이지</div>}
          />
          <Route
            path={ROUTES.PROFILE_SETUP}
            element={<div>프로필 설정 페이지</div>}
          />
          <Route
